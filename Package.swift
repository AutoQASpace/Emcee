...
let package = Package(
    ...
    dependencies: [
        .package(name: "CommandLineToolkit", url: "https://github.com/AutoQASpace/CommandLineToolkit", .branch("fix_dependency-pid-kill")),
        ...
        .package(name: "Shout", url: "https://github.com/AutoQASpace/Shout", .branch("fix_dependency")),
